...
import org.example.util.HttpImpl;
...
public class AddressRetriever {
    ...
    public Address retrieve(double latitude, double longitude) throws IOException, ParseException, org.json.simple.parser.ParseException {
